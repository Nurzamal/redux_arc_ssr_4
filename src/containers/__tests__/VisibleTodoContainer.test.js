...
import { mapDispatchToProps, withServerState, mapStateToProps, VisibleTodoList } from '/containers/__tests__/VisibleTodoContainer'


describe('VisibleTodoContainer tests', () => {
  ...
  it('componentWillMount test', () => {
    ...
    const wrapper = mount(<VisibleTodoContainer {...props} />)
  })
